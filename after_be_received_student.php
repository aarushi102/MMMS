...
<p align="center" style="font-size: 20px;">
   ...
   <table border="0" align="center" height="125px%" width="50%" cellspacing="5px">
    <tr>
        <td colspan="2" cellspacing="5px">
            <b>Company : </b>
            <input type="text" name="company" value="<?php echo $row['company']?>" style="margin: 15px; width: 88%; height: 50%;" disabled >
        </td> 
    </tr>
   
    <td colspan="2" cellspacing="5px">
        <b>Package : </b>
        <input type="text" name="package" value="<?php echo $row['package']?>" style="margin: 15px; width: 89%; height: 50%;" disabled>
    </td> 
   </table>
  ...
  <td align="center" width="8">
   ...
   <tr style="margin: 0px; width: 86%; height: 40%;">
    ...
    <td>
        <textarea name="gre_score" id="gre_score" disabled> <?php echo $row['gre_score']?></textarea>
    </td>

    <td>
        <textarea name="tofel_score" id="tofel_score"  disabled><?php echo $row['tofel_score']?></textarea>
    </td>

    <td>
        <textarea name="cat_score" id="cat_score"  disabled><?php echo $row['cat_score']?></textarea>
    </td>

    <td>
        <textarea name="gate_score" id="gate_score"  disabled><?php echo $row['gate_score']?></textarea>
    </td>
   </tr>
   </table>
...
<p align="center" style="font-size: 20px;">
   ...
   <table border="0" align="center" height="125px%" width="50%" cellspacing="5px">
    <tr>
        <td colspan="2" cellspacing="5px">
            <b>University : </b>
            <input type="text" name="university" value="<?php echo $row['university']?>" style="margin: 15px; width: 87%; height: 50%;" disabled>
        </td> 
    </tr>
    <td colspan="2" cellspacing="5px">
        <b>Country : </b>
        <input type="text" name="country" value="<?php echo $row['country']?>" style="margin: 15px; width: 89%; height: 50%;" disabled>
    </td> 
   </table>
