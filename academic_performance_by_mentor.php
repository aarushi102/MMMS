...
<body>
    ...
    while ($row = mysqli_fetch_assoc($query_run)) 
  {
    ...
    <table align="center" border="1" height="700px" width="85%" cellspacing="0">
      <tr>
      ...
      <tr>
        ...
        <tr>
            ...
            <td align="center" height="25px" rowspan="1" colspan="2" width="10%">
                <textarea name="sem1_ia1_remark" id="sem1_ia1_remark" style="margin: 0px; width: 98%; height: 80%;"><?php echo $row['sem1_ia1_remark']?></textarea>
            </td>
        ...
        <tr>
          ...
          <tr>
              ...
              <td align="center" height="25px" rowspan="1" colspan="2" width="10%">
                  <textarea name="sem6_end_sem_remark" id="sem6_end_sem_remark" style="margin: 0px; width: 98%; height: 80%;"><?php echo $row['sem6_end_sem_remark']?></textarea>
              </td>
