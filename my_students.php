...
<head>
	...
	<link rel="stylesheet" type="text/css" href="bootstrap-4.4.1/css/my_student.css"> 
...
<body>
	<center><br><br>
	<h1>Student's Mentoring </h1><br><!-- <br><br> -->
	<div id ="login-form">
	...
	<?php
        ...
        if(isset($_POST['attendance'])){
			header("Location: attendance_given_by_mentor.php?r_no=".$_GET['r_no']."");
		}

        if(isset($_POST['activities'])){
			header("Location: activities_by_mentor.php?r_no=".$_GET['r_no']."");
		}

        if(isset($_POST['feedback'])){
			header("Location: feedback_by_mentor.php?r_no=".$_GET['r_no']."");
		}

		if(isset($_POST['extra_curricular_activities'])){
			header("Location: extra_curricular_by_mentor.php?r_no=".$_GET['r_no']."");
		}

		if(isset($_POST['after_be'])){
			header("Location: after_be_by_mentor.php?r_no=".$_GET['r_no']."");
		}
		
		if(isset($_POST['academic_performance'])){
			header("Location: academic_performance_by_mentor.php?r_no=".$_GET['r_no']."");
		}
